...
ARG VERSION=
ARG PORT=4001
ARG SOURCE=https://github.com/connectusglobal/rtls-api
ARG NODE_ENV=production

LABEL com.connectusglobal.rtls-api.revision=$GIT_COMMIT
LABEL com.connectusglobal.rtls-api.created=$BUILD_DATE
LABEL com.connectusglobal.rtls-api.source=$SOURCE
LABEL com.connectusglobal.rtls-api.version=$VERSION
LABEL com.connectusglobal.rtls-api.vendor="Connectus Global"
LABEL com.connectusglobal.rtls-api.authors="Connectus IT <it@connectusglobal.com"
...
tee $(pwd)/package.json <<'EOF' > /dev/null
{
  ...
  "name": "rtls-api",
  "description": "RTLS-API",
  "repository": "https://github.com/connectusglobal/rtls-api.git",
